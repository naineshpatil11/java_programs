...
public class QueueForCalender9 
{
	static QueueForCalender9 qc=new QueueForCalender9();
	public static void QueueCalender(int month, int year) 
	{
		String s[] = { "January", "Februry", "March", "April", "May", "June", "July", "August", "September", "October",
				"November", "December" };
		Queue1<String> q1 = new Queue1<>();
		//Queue<String> q1=new Queue<>(); 
		
		// get d0 value hence upto d0 we will add null
		//values
		...
		if (month == 2) 
		{
			if (QueueForCalender9.isLeapYear(year)) //leap year days = 29
				totalDaysOfMonth = 29;
			else
