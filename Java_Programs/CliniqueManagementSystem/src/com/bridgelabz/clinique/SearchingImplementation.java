...
public class SearchingImplementation 
{
	...
	//to store data in arraylist
		...
		List<Appoitment> appointmentlist = new ArrayList<>();
		{
			try {
				// read files into arraylist
				personlist = mapper.readValue(
						new File("/home/user/Documents/Java_Programs/CliniqueManagementSystem/Patients.json"),
						new TypeReference<List<Patients>>() {
						});
				doctorlist = mapper.readValue(
						new File("/home/user/Documents/Java_Programs/CliniqueManagementSystem/Doctors.json"),
		...
		//	System.out.println("Enter id");
			id = Utility.inputInteger("Enter id");
			try {
